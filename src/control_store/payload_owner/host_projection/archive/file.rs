...
pub(in crate::control_store::payload_owner::host_projection) async fn open_owned_regular_file(
    path: &Path,
    label: &str,
...
pub(in crate::control_store::payload_owner::host_projection) async fn inspect_owned_regular_file(
    path: &Path,
    label: &str,
