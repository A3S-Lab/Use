...
fn help() -> CommandOutput {
    CommandOutput::success(
        concat!(
            ...
            "  a3s-use office native get|query|view|raw|raw-set|dump|validate|create|add|add-part|set|remove|insert-rows|delete-rows|insert-columns|delete-columns|rename-sheet|move-sheet|copy-sheet|batch [args] [--json]\n",
