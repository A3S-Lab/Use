...
are metadata only: the current adapter still publishes schema-validated MCP
Tools, and Flow/Knowledge/UI resources or prompts remain a later host-owned
projection. See [Capability consumer profiles](docs/capability-consumer-profiles.md)
