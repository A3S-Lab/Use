...
non-empty inventory must retain at least one snapshot. Descriptor clean-target
restore, production Control registration, and lifecycle activation still
supply the authority that chooses and reopens descriptor generations.
