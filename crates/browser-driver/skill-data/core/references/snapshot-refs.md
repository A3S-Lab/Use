...
a3s use browser click @e6

# Fill email input
a3s use browser fill @e10 "user@example.com"

# Fill password
a3s use browser fill @e11 "password123"

# Submit the form
a3s use browser click @e12
```
...
a3s use browser snapshot -i          # Get refs first
a3s use browser click @e1            # Use ref

# WRONG
a3s use browser open https://example.com
a3s use browser click @e1            # Ref doesn't exist yet!
```

### 2. Re-Snapshot After Navigation

```bash
a3s use browser click @e5            # Navigates to new page
a3s use browser snapshot -i          # Get new refs
a3s use browser click @e1            # Use new refs
```

### 3. Re-Snapshot After Dynamic Changes

```bash
a3s use browser click @e1            # Opens dropdown
a3s use browser snapshot -i          # See dropdown items
a3s use browser click @e7            # Select item
```
...
a3s use browser fill @e3 "4111111111111111"
a3s use browser fill @e4 "12/28"
