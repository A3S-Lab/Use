...
pub use plugin::{
    ...
    PLUGIN_HOST_CANCEL_RESULT_SCHEMA, PLUGIN_HOST_CAPABILITIES_SCHEMA_V4,
    PLUGIN_HOST_CAPABILITIES_SCHEMA_V5, PLUGIN_HOST_ENABLEMENT_PLAN_REQUEST_SCHEMA,
    ...
    PLUGIN_HOST_PROTOCOL_LEVEL_V5, PLUGIN_MANAGED_SCOPE_SCHEMA, PLUGIN_MANAGER_TOOLSET_SCHEMA_V4,
    PLUGIN_OPERATION_CONFIRMATION_SCHEMA, PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA_V3,
