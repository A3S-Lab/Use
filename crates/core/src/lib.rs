...
pub use plugin::{
    ...
    WorkspaceGrantProposalAuthority, CAPABILITY_DESCRIPTION_PROOF_SCHEMA_V1,
    CAPABILITY_DESCRIPTOR_SCHEMA_V1, CAPABILITY_GATEWAY_CATALOG_SCHEMA_V1,
    INSTALLATION_SNAPSHOT_SCHEMA, INSTALLED_PLUGIN_PLAN_EVIDENCE_SCHEMA, MAX_INSTALLATION_PACKAGES,
    MAX_INSTALLATION_ROOTS, MAX_INSTALLATION_SNAPSHOT_BYTES, MAX_PLUGIN_CONTRACT_BYTES,
