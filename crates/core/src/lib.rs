...
pub use plugin::{
    ...
    PluginHostUnavailableReason, PluginManagedScope, PluginManagerToolAnnotations,
    PluginManagerToolDefinition, PluginManagerToolset, PluginObservedState, PluginOperationAction,
    ...
    PluginPackageId, PluginPackageLock, PluginPackageLockHost, PluginPackageResolver,
    ...
    PLUGIN_MANAGED_SCOPE_SCHEMA, PLUGIN_MANAGER_TOOLSET_SCHEMA, PLUGIN_MANAGER_TOOLSET_SCHEMA_V2,
    ...
    PLUGIN_OPERATION_PLAN_SCHEMA, PLUGIN_OPERATION_PLAN_SCHEMA_V2, PLUGIN_PACKAGE_LOCK_SCHEMA,
