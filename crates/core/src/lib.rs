...
pub use plugin::{
    capability_schema_digest, ArtifactRef, CapabilityConsumerExtension, CapabilityConsumerKind,
    ...
    ResourceRef, SignedCapabilityDescription, SurfaceChangeKind, SurfacePermissionCeiling,
    ToolWorkloadClass, UiHttpPermission, VerifiedCatalogProvenance, VerifiedPluginCatalogRecord,
    WorkspaceGrantAuthority, WorkspaceGrantEvidence, WorkspaceGrantProposalAuthority,
    CAPABILITY_CONSUMER_NEGOTIATION_SCHEMA_V1, CAPABILITY_CONSUMER_PROFILE_SCHEMA_V1,
    CAPABILITY_DESCRIPTION_PROOF_SCHEMA_V1, CAPABILITY_DESCRIPTION_SIGNATURE_ALGORITHM_ED25519,
    CAPABILITY_DESCRIPTION_SIGNATURE_SCHEMA_V1, CAPABILITY_DESCRIPTOR_SCHEMA_V1,
    CAPABILITY_GATEWAY_CATALOG_SCHEMA_V1, CAPABILITY_SCHEMA_DIGEST_SCHEMA_V1,
    INSTALLATION_SNAPSHOT_SCHEMA, INSTALLED_PLUGIN_PLAN_EVIDENCE_SCHEMA,
