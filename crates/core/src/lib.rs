...
pub use plugin::{
    ...
    PluginHostPlanResult, PluginHostUnavailableReason, PluginManagedScope,
    ...
    MAX_PLUGIN_CONTRACT_BYTES, MAX_PLUGIN_PACKAGE_DEPENDENCIES, MAX_PLUGIN_PLAN_ITEMS,
    MAX_PLUGIN_RESOLUTION_CANDIDATES, PLUGIN_CATALOG_SCHEMA, PLUGIN_CATALOG_SCHEMA_V2,
    PLUGIN_CATALOG_SCHEMA_V3, PLUGIN_GRANT_CONFIRMATION_SCHEMA, PLUGIN_HOST_APPLY_REQUEST_SCHEMA,
    PLUGIN_HOST_APPLY_RESULT_SCHEMA, PLUGIN_HOST_CAPABILITIES_SCHEMA,
    ...
    PLUGIN_HOST_PLAN_RESULT_SCHEMA, PLUGIN_HOST_PROTOCOL_LEVEL, PLUGIN_HOST_PROTOCOL_LEVEL_V2,
    ...
    PLUGIN_MANAGER_TOOLSET_SCHEMA_V3, PLUGIN_OPERATION_CONFIRMATION_SCHEMA,
    PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA, PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA_V2,
    PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA_V3, PLUGIN_OPERATION_PLAN_SCHEMA,
    PLUGIN_OPERATION_PLAN_SCHEMA_V2, PLUGIN_OPERATION_PLAN_SCHEMA_V3,
    PLUGIN_OPERATION_PLAN_SCHEMA_V4, PLUGIN_PACKAGE_LOCK_SCHEMA, PLUGIN_PERMISSION_SCHEMA,
