...
pub use plugin::{
    ...
    CatalogPlanningTarget, CatalogSurface, FilesystemAccess, FilesystemPermission, FilesystemScope,
    HttpMethod, InstalledPluginPlanEvidence, NetworkEgressPermission, PlanActor, PlanAuthority,
