...
pub use plugin::{
    ArtifactRef, CapabilityConsumerExtension, CapabilityConsumerKind,
    ...
    CapabilityToolAnnotations, CatalogArchive, CatalogAvailability, CatalogMcpTransport,
    CatalogPackage, CatalogPlanningTarget, CatalogSurface, EndpointRef, ExecutablePlanningSurface,
    ...
    PluginManagerPackageScopeInput, PluginManagerSearchInput, PluginManagerToolAnnotations,
    PluginManagerToolDefinition, PluginManagerToolset, PluginManagerUpgradePlanInput,
    PluginObservedState, PluginOperationAction, PluginOperationConfirmation, PluginOperationPlan,
    PluginOperationPlanBinding, PluginOperationPlanDraft, PluginOperationPlanEnvelope,
    PluginPackageDependency, PluginPackageId, PluginPackageLock, PluginPackageLockHost,
    PluginPackageResolver, PluginPermissionCeiling, PluginPlanSource, PluginPlanningBundle,
    PluginReleaseChannel, PluginSurfaceKind, PluginSurfaceRef, PluginWorkspaceGrant,
    ...
    ResourceRef, SurfaceChangeKind, SurfacePermissionCeiling, ToolWorkloadClass, UiHttpPermission,
    VerifiedCatalogProvenance, VerifiedPluginCatalogRecord, WorkspaceGrantAuthority,
    WorkspaceGrantEvidence, WorkspaceGrantProposalAuthority,
    CAPABILITY_CONSUMER_NEGOTIATION_SCHEMA_V1, CAPABILITY_CONSUMER_PROFILE_SCHEMA_V1,
    CAPABILITY_DESCRIPTION_PROOF_SCHEMA_V1, CAPABILITY_DESCRIPTOR_SCHEMA_V1,
    CAPABILITY_GATEWAY_CATALOG_SCHEMA_V1, INSTALLATION_SNAPSHOT_SCHEMA,
    INSTALLED_PLUGIN_PLAN_EVIDENCE_SCHEMA, MAX_CAPABILITY_CONSUMER_EXTENSIONS,
    MAX_INSTALLATION_PACKAGES, MAX_INSTALLATION_ROOTS, MAX_INSTALLATION_SNAPSHOT_BYTES,
    MAX_PLUGIN_CONTRACT_BYTES, MAX_PLUGIN_HOST_OPERATION_WATCH_TIMEOUT_MS,
    MAX_PLUGIN_PACKAGE_DEPENDENCIES, MAX_PLUGIN_PLAN_ITEMS, MAX_PLUGIN_RESOLUTION_CANDIDATES,
    PLUGIN_CATALOG_SCHEMA_V3, PLUGIN_GRANT_CONFIRMATION_SCHEMA, PLUGIN_HOST_APPLY_REQUEST_SCHEMA,
    ...
    PLUGIN_MANAGER_TOOLSET_SCHEMA_V5, PLUGIN_OPERATION_CONFIRMATION_SCHEMA,
    PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA_V3, PLUGIN_OPERATION_PLAN_SCHEMA_V4,
    PLUGIN_PACKAGE_LOCK_SCHEMA, PLUGIN_PERMISSION_SCHEMA, PLUGIN_PLANNING_BUNDLE_SCHEMA,
    PLUGIN_WORKSPACE_GRANT_CHANGE_SET_SCHEMA, PLUGIN_WORKSPACE_GRANT_PROPOSAL_SCHEMA,
    PLUGIN_WORKSPACE_GRANT_SCHEMA, PLUGIN_WORKSPACE_GRANT_SNAPSHOT_SCHEMA,
};
pub use release::{
