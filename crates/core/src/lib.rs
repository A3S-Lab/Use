...
pub use plugin::{
    ...
    PLUGIN_HOST_CAPABILITIES_SCHEMA, PLUGIN_HOST_ENABLEMENT_REQUEST_SCHEMA,
    ...
    PLUGIN_HOST_PLAN_RESULT_SCHEMA, PLUGIN_HOST_PROTOCOL_LEVEL, PLUGIN_MANAGED_SCOPE_SCHEMA,
    ...
    PLUGIN_OPERATION_PLAN_SCHEMA_V2, PLUGIN_PERMISSION_SCHEMA, PLUGIN_PLANNING_BUNDLE_SCHEMA,
