...
pub use plugin::{
    ...
    PluginManagerUpgradePlanInput, PluginObservedState, PluginOperationAction,
    ...
    WorkspaceGrantProposalAuthority, CAPABILITY_CONSUMER_NEGOTIATION_SCHEMA_V1,
    CAPABILITY_CONSUMER_PROFILE_SCHEMA_V1, CAPABILITY_DESCRIPTION_PROOF_SCHEMA_V1,
