...
pub use plugin::{
    ...
    CapabilityMcpTransport, CapabilityPublicationEvidence, CapabilityToolAnnotations,
    CatalogArchive, CatalogAvailability, CatalogMcpTransport, CatalogPackage,
    CatalogPlanningTarget, CatalogSurface, EndpointRef, ExecutablePlanningSurface,
