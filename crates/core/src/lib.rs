...
pub use plugin::{
    ...
    PlannedWorkspaceImpact, PluginCatalogRecord, PluginGrantConfirmation,
    PluginManagerToolAnnotations, PluginManagerToolDefinition, PluginManagerToolset,
    PluginOperationAction, PluginOperationPlan, PluginOperationPlanEnvelope,
    PluginPermissionCeiling, PluginPlanSource, PluginReleaseChannel, PluginSurfaceKind,
    PluginSurfaceRef, PluginWorkspaceGrant, PluginWorkspaceGrantProposal,
    ResourcePermissionCeiling, SurfaceChangeKind, SurfacePermissionCeiling, ToolWorkloadClass,
    UiHttpPermission, VerifiedCatalogProvenance, VerifiedPluginCatalogRecord,
    WorkspaceGrantAuthority, WorkspaceGrantProposalAuthority, MAX_PLUGIN_CONTRACT_BYTES,
    PLUGIN_CATALOG_SCHEMA, PLUGIN_GRANT_CONFIRMATION_SCHEMA, PLUGIN_MANAGER_TOOLSET_SCHEMA,
    PLUGIN_OPERATION_PLAN_SCHEMA, PLUGIN_PERMISSION_SCHEMA, PLUGIN_WORKSPACE_GRANT_PROPOSAL_SCHEMA,
