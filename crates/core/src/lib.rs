...
pub use plugin::{
    ...
    FilesystemAccess, FilesystemPermission, FilesystemScope, HttpMethod,
    InstalledPluginPlanEvidence, NetworkEgressPermission, PlanActor, PlanAuthority,
    PlanEnforcementProfile, PlanPackageChangeKind, PlanPackageRole, PlanPolicyDecision,
    PlanQualifiedSurfaceRef, PlanScope, PlanScopeKind, PlannedOperationImpact, PlannedPackageState,
    ...
    PlannedWorkspaceGrantChange, PlannedWorkspaceImpact, PluginCatalogRecord,
    ...
    PluginSurfaceRef, PluginWorkspaceGrant, PluginWorkspaceGrantChangeSet,
    ...
    PLUGIN_CATALOG_SCHEMA_V2, PLUGIN_GRANT_CONFIRMATION_SCHEMA, PLUGIN_MANAGER_TOOLSET_SCHEMA,
    PLUGIN_OPERATION_CONFIRMATION_SCHEMA, PLUGIN_OPERATION_PLAN_DRAFT_SCHEMA,
    PLUGIN_OPERATION_PLAN_SCHEMA, PLUGIN_PERMISSION_SCHEMA,
