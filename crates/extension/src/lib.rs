...
pub use artifact_store::{
    ...
    ArtifactGarbageCollectionTarget, ArtifactInventoryEntry, ArtifactKind, ArtifactPhysicalState,
    ArtifactQuarantinePlan, ArtifactQuarantineRecord, ArtifactQuarantineResult,
    ArtifactReferenceAdmission, ArtifactRehydrationPlan, ArtifactRehydrationRecord,
    ArtifactRehydrationResult, ArtifactStorageQuotaAction, ArtifactStorageQuotaMutation,
    ArtifactStorageQuotaPolicy, ArtifactStorageQuotaSnapshot, ArtifactStore,
    ArtifactStoreDigestAudit, ArtifactStoreInventory, VerifiedArtifactPackage,
    ARTIFACT_GARBAGE_COLLECTION_PLAN_SCHEMA, ARTIFACT_GARBAGE_COLLECTION_RECORD_SCHEMA,
    ARTIFACT_GARBAGE_COLLECTION_RESULT_SCHEMA, ARTIFACT_QUARANTINE_PLAN_SCHEMA,
    ARTIFACT_QUARANTINE_RECORD_SCHEMA, ARTIFACT_QUARANTINE_RESULT_SCHEMA,
    ARTIFACT_REHYDRATION_PLAN_SCHEMA, ARTIFACT_REHYDRATION_RECORD_SCHEMA,
    ARTIFACT_REHYDRATION_RESULT_SCHEMA, ARTIFACT_STORAGE_QUOTA_POLICY_SCHEMA_VERSION,
    ARTIFACT_STORE_DIGEST_AUDIT_SCHEMA, ARTIFACT_STORE_INVENTORY_SCHEMA,
    MAX_ARTIFACT_GARBAGE_COLLECTION_TARGETS, MAX_ARTIFACT_STORAGE_QUOTA_ARTIFACTS,
