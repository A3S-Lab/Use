...
export const homeCopy: Record<Locale, HomeCopy> = {
  zh: {
    ...
    surfaces: {
      ...
      okf: {
        label: "OKF",
        kind: "OPEN KNOWLEDGE FORMAT · TARGET",
        title: "可共享、可索引的知识包",
        body: "OKF v0.2 用带 YAML frontmatter 的交叉链接 Markdown 表达概念，并兼容 v0.1。目标实现中，Use 将验证内容与代际；A3S Knowledge 只索引原子发布的合规 bundle。",
        evidence: [
          "type frontmatter",
          "concept graph",
  ...
  en: {
    ...
    surfaces: {
      ...
      okf: {
        ...
        body: "OKF v0.2 represents concepts as cross-linked Markdown with YAML frontmatter and preserves v0.1 compatibility. In the target implementation, Use will verify content and generation; A3S Knowledge will index only atomically promoted conformant bundles.",
        evidence: [
          "type frontmatter",
          "concept graph",
          "atomic index generation",
