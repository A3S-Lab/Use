...
该 store 仍是未激活的 external owner，尚未登记到 backup/restore；Runtime payload/schema
attestation 与生产 Control/Runtime wiring 仍未完成。真实组合测试已经覆盖 Knowledge、Skill、catalog/Index cutover、stale admission 与
