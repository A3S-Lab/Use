...
package，同时禁止同一 surface 的两个 lifecycle incarnation。live-host
reference resolution、endpoint authentication/authorization、rate limit、CLI
接线及独立 client/recovery 矩阵仍未完成。
