...
archive nor a receipt. Deferred effects remain safe-no-effect scheduling
evidence; claimed and unknown effects remain reconciliation evidence only.
None selects desired state. A verified owner snapshot can now stage and re-audit its exact
