...
creates no archive. These remain inactive owner primitives; Restore Coordinator
activation and self-hosted journal reconciliation, complete-set coordination,
full subprocess-exit qualification, production orchestration, and coordinated
