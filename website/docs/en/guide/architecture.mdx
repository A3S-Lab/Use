...
plus exact post-publication replay close each local crash boundary. These remain
inactive owner primitives; the Restore Coordinator adapter, complete-set
coordination, full subprocess-exit qualification, production orchestration, and
