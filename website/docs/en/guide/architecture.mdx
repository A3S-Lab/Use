...
external owner and is not yet registered for backup/restore. Runtime payload/
schema attestation and production Control/Runtime wiring remain open. A real composition test covers Knowledge, Skill, catalog/Index
