...
Production composition must still supply the durable host source and atomic
dispatcher from committed Control authority and immutable artifacts; the
process-local Runtime selection used for qualification is not production
authority.
