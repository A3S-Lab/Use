...
an absent database as zero files without mutating live state. The other owner
adapters, Knowledge staged restore/activation and Control-effect
reconciliation, production orchestration, and the coordinated authority
cutover remain disabled until every consumer can switch together.
