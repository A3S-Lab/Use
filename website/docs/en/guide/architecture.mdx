...
attempt and fence remain held. This is an inactive owner primitive;
the other owner adapters, complete-set restore coordinator, full process-exit
qualification, production orchestration, and coordinated authority cutover
