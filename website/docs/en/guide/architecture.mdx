...
remains unknown. Runtime/Flow production composition must still reconstruct
all inputs after restart only from committed Control authority and immutable
artifacts; the process-local Runtime selection used for qualification is not
