...
receipt set with schema, digest, and accounting bounds. This evidence contract
does not copy payloads or replace the legacy backup scanner. Real owner
snapshot/verification/restore adapters, owner-port dispatch, production
orchestration, and the coordinated authority cutover remain disabled until
