...
The inactive schema-v8 kernel now derives that complete outbox inventory from
...
effects. Production orchestration and the coordinated authority cutover remain
