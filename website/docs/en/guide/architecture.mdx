...
reference guard spans the distinct Control commit. Runtime, Flow, Capability
Index, invocation-lease adapters, and production composition must derive all
inputs only from committed Control authority and immutable artifacts.
