...
rebinding, and candidate drift fail closed. Complete-set activation, its
cross-owner crash journal and full subprocess-exit qualification, production
backup/restore wiring, and coordinated authority cutover remain disabled until
every consumer can switch together.
