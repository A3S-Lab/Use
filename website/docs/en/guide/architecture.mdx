...
after activation starts, and the result remains path-free. These remain
inactive owner primitives; the Host projection and Restore Coordinator
adapters, complete-set coordination, full subprocess-exit qualification,
production orchestration, and coordinated authority cutover remain disabled
until every consumer can switch together.
