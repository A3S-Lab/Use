...
references. This remains a deterministic subset gate: key custody, durable
proof snapshots for crash retry, runtime payload attestation, and production
Control/Runtime wiring remain open. The inactive Flow owner now follows the
