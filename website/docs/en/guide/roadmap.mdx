...
- The path-free `CapabilityDescriptor` and catalog contracts, opaque reference
  ...
  discovery/invocation check are also implemented. Live reference resolution,
  per-consumer authorization, CLI wiring, TLS termination, and production-host
...
- Complete live server-side invocation-reference resolution, per-consumer
  authorization, CLI/service wiring, TLS deployment, and production recovery.
