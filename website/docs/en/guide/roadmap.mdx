...
admission, and same-key drain retry. Production lifecycle still does not
construct the dispatcher; Runtime, Flow, and composition must use the same
committed Control boundary.
