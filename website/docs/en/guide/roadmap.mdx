...
Production lifecycle still does not construct the dispatcher: it must supply
the durable host source and atomic composition rather than use the process-local
selection retained by this qualification.
