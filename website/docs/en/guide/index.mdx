...
receipt v6, plan v4, host protocol v6, managed scope v2, manager tools v5,
...
verification.
Release workflow
[33687297386](https://github.com/A3S-Lab/Use/actions/runs/33687297386) then passed
...
`a3s-use-extension 0.3.7`, and `a3s-use 0.3.7`). See [Trust & Security](./trust-security)
for the remaining bootstrap boundary and optional GitHub attestation
verification.
Release workflow
[33720485826](https://github.com/A3S-Lab/Use/actions/runs/33720485826) then passed
...
`a3s-use-extension 0.3.8`, and `a3s-use 0.3.8`). See [Trust & Security](./trust-security)
for the remaining bootstrap boundary and optional GitHub attestation
verification.
Release workflow
[33756618837](https://github.com/A3S-Lab/Use/actions/runs/33756618837) then passed
all 13 jobs for tag `v0.3.9` at exact `main` commit
`a5f3cc40bfb0a1021ca150d2ce4295409b74d220` and published the current
development-preview [v0.3.9 Release](https://github.com/A3S-Lab/Use/releases/tag/v0.3.9),
including 19 verified release assets and typed crates (`a3s-use-core 0.2.7`,
`a3s-use-extension 0.3.9`, and `a3s-use 0.3.9`). See [Trust & Security](./trust-security)
for the remaining bootstrap boundary and optional GitHub attestation
verification.
Release workflow
[33791616307](https://github.com/A3S-Lab/Use/actions/runs/33791616307) then passed
all 13 jobs for tag `v0.3.10` at exact `main` commit
`c4c80a223bfff3698ca4b4598e7175c6e3303239` and published the current
development-preview [v0.3.10 Release](https://github.com/A3S-Lab/Use/releases/tag/v0.3.10),
including 19 verified release assets and typed crates (`a3s-use-core 0.2.8`,
`a3s-use-extension 0.3.10`, and `a3s-use 0.3.10`). See [Trust & Security](./trust-security)
for the remaining bootstrap boundary and optional GitHub attestation
verification.
Release workflow
[33830280138](https://github.com/A3S-Lab/Use/actions/runs/33830280138) then passed
...
development-preview [v0.3.11 Release](https://github.com/A3S-Lab/Use/releases/tag/v0.3.11),
including 19 verified release assets and typed crates (`a3s-use-core 0.2.9`,
`a3s-use-extension 0.3.11`, and `a3s-use 0.3.11`). See [Trust & Security](./trust-security)
for the remaining bootstrap boundary and optional GitHub attestation
verification.
